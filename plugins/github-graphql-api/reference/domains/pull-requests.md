...
- **mergeable** ([`MergeableState!`](#mergeablestate)): Whether or not the pull request can be merged based on the existence of merge conflicts.
...
Whether or not a PullRequest can be merged. _Also defined in [common.md](common.md)._
...
**See also:** [Issues](issues.md) | [Repositories](repositories.md) | [Git Objects](git-objects.md) | [Actions & CI](actions-and-ci.md)
